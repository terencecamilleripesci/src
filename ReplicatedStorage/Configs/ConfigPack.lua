-- #############################################################
-- 📦 Legends Reborn - ConfigPack.lua (v4.8.1 FINAL - fixed)
-- #############################################################
...
Config.Stats = {
    ...
    Caps = {
        HealthMax=9999, ManaMax=9999, StaminaMax=9999,
        StrengthMax=2000, DefenseMax=2000
    },
    ...
    -- Optional Magical mitigation (future)
...
-- =========================
Config.Combat = {
    GlobalCooldown = 0.1, -- tiny shared GCD to prevent animation-cancel exploits
}
...
-- =========================
Config.Movement = {
    -- Default: always double jump (1 base + 1 extra)
...
Config.DamageTypes = {
    Physical = {
        ...
        MitigationMultiplier=0.001,
        Cap=0.75,
    },
    Magical  = {
        StatScale="Mana",
        Multiplier=0.0025,
        MitigationStat = "Defense", -- or "MagicResist" if UseMagicResist=true
        MitigationMultiplier=0.001,
        Cap=0.75,
    }
}
...
Config.Quests = {
    Example = {
        ...
        Target = "Bandit",
        Amount = 10,
        Reward = { XP=100, Gold=50, Item="WindBoots" },
    }
}
