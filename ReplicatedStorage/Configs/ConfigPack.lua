-- #############################################################
-- 📦 Legends Reborn - ConfigPack.lua (v4.8.2 CLEAN)
-- #############################################################
...
Config.Stats = {
    ...
    Caps = {
        HealthMax  = 9999, ManaMax  = 9999, StaminaMax  = 9999, StrengthMax  = 2000, DefenseMax  = 2000,
        MaxHealth  = 9999, MaxMana  = 9999, MaxStamina  = 9999, MaxStrength  = 2000, MaxDefense  = 2000,
    },
...
-- 🎒 HOTBAR
-- =========================
Config.Hotbar = { Slots = { [1]="MartialArts", [2]="Weapons", [3]="Internals", [4]="Pets" }, MaxSlots = 4 }
...
Config.Gear = {
    ...
    Items = {
        WindBoots = {
            Slot = "Boots",
            Name = "Wind Boots",
            Modifiers = { MaxStamina = 20, StaminaMax = 20, ExtraJump = 1, DashRangePct = 0.10 },
        },
        IronHelm = {
            Slot = "Head",
            Name = "Iron Helm",
            Modifiers = { Defense = 10, MaxHealth = 25, HealthMax = 25 },
        },
    },
}
...
-- 🛡️ BUFFS & ☠️ DEBUFFS
-- =========================
Config.Buffs = { IronGuard = { DefenseBoost = 0.2, Duration = 5 } }
Config.Debuffs = {
